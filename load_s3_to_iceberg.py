...
LIVY_URL = "https://go01-obsr-de-gateway.go01-dem.ylcu-atmi.cloudera.site:443/go01-obsr-de/cdp-proxy-api/livy_for_spark3/"
...
spark = SparkSession.builder \
    ...
    .config("spark.sql.catalog.hive_catalog.uri", "thrift://go01-obsr-de-master0.go01-dem.ylcu-atmi.cloudera.site:9083") \
